...
-(void)login:(UIViewController *)viewController
{
    ...
    NSBundle *bundle=[NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"LNLoginKit" withExtension:@"bundle"]];
    UIStoryboard *loginSB = [UIStoryboard storyboardWithName:@"Login" bundle:bundle];
